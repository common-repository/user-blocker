...
You have any suggestion with User Blocker plugin or you found a bug, please contact us at [support.solwininfotech.com](http://support.solwininfotech.com).
...
3. Click on **Activate Now** after installed in backend

= From WordPress.org =

1. Download **User Blocker**
2. Upload the **user-blocker** directory to your '/wp-content/plugins/' directory, using one of your favorite method (ftp, sftp, scp, etc.)
...
* Updated: Make compatible with WordPress 6.5.4
* Fixed: Solve minor issues
...
* Added: Export CSV Data for blocked users or roles 
* Updated: Make compatible with WordPress 5.8
* Updated: Make compatible with PHP 8.0
* Fixed: Solve minor issues
...
* Updated: Make compatible with WordPress 5.4

= 1.5 =
Release date: December 19th, 2019

* Enhancement: Make compatible with WordPress 5.3.2
* Fixed: Site Health issue

= 1.4 =
Release date: July 15th, 2019

* Enhancement: Make compatible with WordPress 5.2.2
* Enhancement: Add Reset to all in block by time user
* Fixed: Apply to all in block by time user
...
* Enhancement: Added support of rtl
* Enhancement: Make compatible with WordPress 5.0
* Fixed: Site slow issue when too many users

= 1.2.3 =
Release date: May 22rd, 2018

* Enhancement: Make compatible with WordPress 4.9.6
* Fixed: Make changes as per GDPR rules

= 1.2.2 =
Release date: August 22th, 2017

* Bug Fix: Issue in use of filter hook - authenticate

= 1.2.1 =
Release date: August 5th, 2017

* Enhancement: Localization file updated to new version

= 1.2 =
Release date: June 14th, 2017

* Enhancement: Make compatible with WordPress 4.8
* Bug Fix: Localization issue resolved

= 1.1.3 =
Release date: January 4th, 2017

* Enhancement: Make compatible with WordPress 4.7

= 1.1.2 =
Release date: August 26th, 2016

* Enhancement: Added support of bbpress plugin
